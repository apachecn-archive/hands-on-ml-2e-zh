...
![precision = \frac{TP}{TP + FP}](img/tex-96d2dbcd621a2da7cff58eaed68d87c2.gif)
...
![recall = \frac{TP}{TP + FN}](img/tex-9fc030ab004eb3b12a815227ce62da52.gif)

FN 是假反例的数目。

如果你对于混淆矩阵感到困惑，图 3-2 将对你有帮助

![图 3-2](img/chapter3.3.jpeg)
...
![F1 = \frac{2}{\frac{1}{precision} + \frac{1}{recall}} = 2 * \frac{precison * recall}{precison + recall} = \frac{TP}{TP + \frac{FN + FP}{2}}](img/tex-dba6270fb2a2c1da75f72bdd3137f6ec.gif)
...
![图 3-3 决策阈值与准确度/召回率折衷](img/chapter3.3-3.jpeg)
...
![图 3-4 准确率和召回率对决策阈值](img/chapter3.4.jpeg)
...
![图 3-5 准确率对召回率](img/chapter3.5.jpeg)
...
![图 3-6 ROC 曲线](img/chapter3.6.jpeg)
...
![图 3-7 比较 ROC 曲线](img/chapter3.7.jpeg)
...
![confuse matrix](img/chapter3.8.jpeg)
...
![5*5 blocks](img/chapter3.10.jpeg)
...
![cleaned-5](img/chapter3.12.jpeg)
